...
func (q *Queries) GetTransfersByFromAccount(ctx context.Context, fromAccountID int64) ([]Transfer, error) {
...
const getTransfersByFromAndToAccount = `-- name: GetTransfersByFromAndToAccount :many
SELECT id, from_account_id, to_account_id, amount, created_at FROM transfers
WHERE from_account_id = $1 AND to_account_id = $2
ORDER BY id
`

type GetTransfersByFromAndToAccountParams struct {
	FromAccountID int64 `json:"from_account_id"`
	ToAccountID   int64 `json:"to_account_id"`
}

func (q *Queries) GetTransfersByFromAndToAccount(ctx context.Context, arg GetTransfersByFromAndToAccountParams) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, getTransfersByFromAndToAccount, arg.FromAccountID, arg.ToAccountID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetTransfersByToAccount(ctx context.Context, toAccountID int64) ([]Transfer, error) {
